function menu(){
    var html = "";
    html += '<ul class="menu">';
    html += '<li class="mlist"><a class="m-item" href="index.html">TOP</a></li>';
    html += '<li class="mlist"><a class="m-item" href="my-info.html">自己紹介</a></li>';
    html += '<li class="mlist"><a class="m-item" href="my-talk.html">講演</a></li>';
    html += '<li class="mlist"><a class="m-item" href="my-paper.html">論文・プレプリント</a></li>';
